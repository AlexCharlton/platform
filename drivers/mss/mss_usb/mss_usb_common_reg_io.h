...
extern "C"
{
    ...
    MSS_USB_CIF_get_mode(
        void)
    {
        return (((USB->DEV_CTRL & DEV_CTRL_HOST_MODE_MASK) ? MSS_USB_CORE_MODE_HOST : MSS_USB_CORE_MODE_DEVICE));
    }
        ...
        void)
    {
        ...
        return (((USB->DEV_CTRL & DEV_CTRL_B_DEVICE_MASK) ? MSS_USB_DEVICE_ROLE_DEVICE_B : MSS_USB_DEVICE_ROLE_DEVICE_A));
    }
    ...
    {
        /* TODO:only valid when session bit is set */
        return (((USB->DEV_CTRL & DEV_CTRL_SESSION_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_cep_is_stall_sent(
        void)
    {
        return (((USB->INDEXED_CSR.DEVICE_EP0.CSR0 & CSR0L_DEV_STALL_SENT_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_cep_is_setupend(
        void)
    {
        return (((USB->INDEXED_CSR.DEVICE_EP0.CSR0 & CSR0L_DEV_SETUP_END_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_txpktrdy(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRL_REG_EPN_TX_PKT_RDY_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_stall_sent_bit(
        mss_usb_ep_num_t ep_num)
    {
        return (uint8_t)(((USB->ENDPOINT[ep_num].TX_CSR & TxCSRL_REG_EPN_STALL_SENT_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_isoincomp(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRL_REG_EPN_ISO_INCOMP_TX_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_get_dma_mode(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRH_REG_EPN_DMA_MODE_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_dma_enabled(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRH_REG_EPN_ENABLE_DMA_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_autoset(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRH_REG_EPN_ENABLE_AUTOSET_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_tx_ep_is_underrun(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].TX_CSR & TxCSRL_REG_EPN_UNDERRUN_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_rxpktrdy(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_RX_PKT_RDY_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_overrun(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_OVERRUN_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_dataerr(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_DATA_ERR_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_stall_sent_bit(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_STALL_SENT_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_isoincomp(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_RX_ISO_INCOMP) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_get_dma_mode(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_DMA_MODE_MASK) ? MSS_USB_DMA_MODE1 : MSS_USB_DMA_MODE0));
    }
    ...
    MSS_USB_CIF_rx_ep_is_dma_enabled(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_ENABLE_DMA_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_piderr(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_ISO_PID_ERR_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_rx_ep_is_autoclr(
        mss_usb_ep_num_t ep_num)
    {
        return (((USB->ENDPOINT[ep_num].RX_CSR & RxCSRL_REG_EPN_ENABLE_AUTOCLR_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
    ...
    MSS_USB_CIF_dma_get_dir(
        mss_usb_dma_channel_t dma_channel)
    {
        return (((USB->DMA_CHANNEL[dma_channel].CNTL & DMA_CNTL_REG_DMA_DIR_MASK) ? MSS_USB_DMA_READ : MSS_USB_DMA_WRITE));
    }
    ...
    MSS_USB_CIF_dma_get_mode(
        mss_usb_dma_channel_t dma_channel)
    {
        return (((USB->DMA_CHANNEL[dma_channel].CNTL & DMA_CNTL_REG_DMA_MODE_MASK) ? MSS_USB_DMA_MODE1 : MSS_USB_DMA_MODE0));
    }
    ...
    MSS_USB_CIF_dma_is_bus_err(
        mss_usb_dma_channel_t dma_channel)
    {
        return (((USB->DMA_CHANNEL[dma_channel].CNTL & DMA_CNTL_REG_DMA_BUS_ERR_MASK) ? MSS_USB_BOOLEAN_TRUE : MSS_USB_BOOLEAN_FALSE));
    }
