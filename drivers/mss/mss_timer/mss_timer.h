...
#define TIM64_ENABLE_MASK 0x00000001u
  ...
  static inline void
  MSS_TIM1_start_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM1_stop_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM1_load_immediate_static(TIMER_TypeDef *timer, uint32_t load_value)
  {
  ...
  static inline void
  MSS_TIM1_load_background_static(TIMER_TypeDef *timer, uint32_t load_value)
  {
  ...
  static inline void
  MSS_TIM1_enable_irq_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM1_clear_irq_static(TIMER_TypeDef *timer)
  {
    timer->TIM1_RIS = 1u;
  }
  ...
  static inline void
  MSS_TIM2_start_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM2_stop_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM2_load_immediate_static(TIMER_TypeDef *timer, uint32_t load_value)
  {
  ...
  static inline void
  MSS_TIM2_load_background_static(TIMER_TypeDef *timer, uint32_t load_value)
  {
  ...
  static inline void
  MSS_TIM2_clear_irq_static(TIMER_TypeDef *timer)
  {
    timer->TIM2_RIS = 1u;
  }
  ...
  static inline void
  MSS_TIM64_start_static(TIMER_TypeDef *timer)
  {
  ...
  static inline void
  MSS_TIM64_stop_static(TIMER_TypeDef *timer)
  {
  ...
  /**
     ...
     @endcode
    */
  void MSS_TIM64_get_current_value(
      TIMER_TypeDef *timer,
      uint32_t *load_value_u,
      uint32_t *load_value_l);

  static inline void
  MSS_TIM64_get_current_value_static(
      TIMER_TypeDef *timer,
      uint32_t *load_value_u,
      uint32_t *load_value_l)
  {
  ...
  /**
     ...
     @return
       This function does not return a value.
    */
  void MSS_TIM64_load_immediate(
      TIMER_TypeDef *timer,
      uint32_t load_value_u,
      uint32_t load_value_l);

  static inline void
  MSS_TIM64_load_immediate_static(
      TIMER_TypeDef *timer,
      uint32_t load_value_u,
      uint32_t load_value_l)
  {
  ...
  /**
     ...
     @return
       This function does not return a value.
    */
  void MSS_TIM64_load_background(
      TIMER_TypeDef *timer,
      uint32_t load_value_u,
      uint32_t load_value_l);

  static inline void
  MSS_TIM64_load_background_static(
      TIMER_TypeDef *timer,
      uint32_t load_value_u,
      uint32_t load_value_l)
  {
  ...
  static inline void
  MSS_TIM64_clear_irq_static(TIMER_TypeDef *timer)
  {
    timer->TIM64_RIS = 1u;
  }
